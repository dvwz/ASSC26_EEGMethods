...
for n=1:nw;
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   %DETRENDING ADDED BY MJP 6/21/2013
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   datawin1=detrend(data1(indx,:));datawin2=detrend(data2(indx,:));
   
% PUT IN IF YOU WANT CONFIDENCE BOUNDS, BUT PARALLEL WON'T WORK (MJP)   
%    if nargout==10;
