%MODALPROJ Modal projection -- unimplemented
%Optional file header info (to give more details about the function than one line)
%Optional file header info (to give more details about the function than one line)
%
% Usage:  
%    [output1,output2] = modalproj(input1)
%    [output1,output2] = modalproj(input1,input2)
%
% Inputs:
%    input1 - Description
%    input2 - Description
...
function [outputs,varargout] = modalproj(inputs,varargin)
...
%INPUT ERRORS
if inputerror1
    error('modalproj:inputError','Error:  Message goes here.');
end
