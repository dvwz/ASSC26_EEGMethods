%GCOH_PLUS Top-level function of the gcoh+ toolbox
% Description:
...
%
% Example: 
%    data = rand(1000, 64); % Random data of 1000 samples with 64 channels
%    epochs = [1 500; 501 1000]; % Define the epochs
%    mtparams.Fs = 250; % Sampling frequency in Hz
%    mtparams.tapers = [3 5]; % Multitaper parameters
%    mtparams.fpass = [0, 125]; % Frequency band of interest
%  
%    gcohparams.savedir = '/path/to/save/dir'; % Path to save the outputs
%    gcohparams.outputdir = '/path/to/output/dir'; % Path to output the plots
%    gcohparams.inference = 'none'; % Inference method
%    gcohparams.version = 'window'; % Version of the algorithm
%    gcohparams.Niter = 200; % Number of iterations for the bootstrap
%    gcohparams.parallel = 0; % Use parallel computing, 0 = no, 1 = yes
%    gcohparams.memory = 0; % Save the intermediate results, 0 = no, 1 = yes
%
